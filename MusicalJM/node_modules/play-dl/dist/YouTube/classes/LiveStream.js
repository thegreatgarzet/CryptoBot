 ...
 */
class Stream {
    constructor(url, type, duration, contentLength, video_url, cookie, options) {
        this.stream = new stream_1.PassThrough({ highWaterMark: 10 * 1000 * 1000 });
        this.url = url;
    ...
    async retry() {
        const info = await __1.video_info(this.video_url, { cookie: this.cookie, proxy: this.proxy });
        const audioFormat = stream_2.parseAudioFormats(info.format);
