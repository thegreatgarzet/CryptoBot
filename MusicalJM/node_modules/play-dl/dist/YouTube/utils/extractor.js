...
const playlist_pattern = /^((?:https?:)?\/\/)?(?:(?:www|m)\.)?(youtube\.com)\/(?:(playlist|watch))(.*)?((\?|\&)list=)PL[a-zA-Z\d_-]{32}(.*)?$/;
/**
...
async function video_basic_info(url, options = {}) {
    ...
    if (player_response.playabilityStatus.status !== 'OK')
        throw new Error(`While getting info from url\n${(_c = (_b = player_response.playabilityStatus.errorScreen.playerErrorMessageRenderer) === null || _b === void 0 ? void 0 : _b.reason.simpleText) !== null && _c !== void 0 ? _c : (_d = player_response.playabilityStatus.errorScreen.playerKavRenderer) === null || _d === void 0 ? void 0 : _d.reason.simpleText}`);
    const badge = ((_h = (_g = (_f = (_e = initial_response.contents.twoColumnWatchNextResults.results.results.contents[1]) === null || _e === void 0 ? void 0 : _e.videoSecondaryInfoRenderer) === null || _f === void 0 ? void 0 : _f.owner) === null || _g === void 0 ? void 0 : _g.videoOwnerRenderer) === null || _h === void 0 ? void 0 : _h.badges) &&
        ((_m = (_l = (_k = (_j = initial_response.contents.twoColumnWatchNextResults.results.results.contents[1]) === null || _j === void 0 ? void 0 : _j.videoSecondaryInfoRenderer) === null || _k === void 0 ? void 0 : _k.owner) === null || _l === void 0 ? void 0 : _l.videoOwnerRenderer) === null || _m === void 0 ? void 0 : _m.badges[0]);
    ...
    const video_details = new Video_1.YouTubeVideo({
        ...
        channel: {
            ...
            verified: Boolean((_p = (_o = badge === null || badge === void 0 ? void 0 : badge.metadataBadgeRenderer) === null || _o === void 0 ? void 0 : _o.style) === null || _p === void 0 ? void 0 : _p.toLowerCase().includes('verified'))
        },
        views: vid.viewCount,
        tags: vid.keywords,
    ...
    format.push(...((_q = player_response.streamingData.formats) !== null && _q !== void 0 ? _q : []));
    format.push(...((_r = player_response.streamingData.adaptiveFormats) !== null && _r !== void 0 ? _r : []));
    const LiveStreamData = {
        isLive: video_details.live,
        dashManifestUrl: (_t = (_s = player_response.streamingData) === null || _s === void 0 ? void 0 : _s.dashManifestUrl) !== null && _t !== void 0 ? _t : null,
        hlsManifestUrl: (_v = (_u = player_response.streamingData) === null || _u === void 0 ? void 0 : _u.hlsManifestUrl) !== null && _v !== void 0 ? _v : null
    };
    return {
        LiveStreamData,
        html5player,
