...
async function stream(url, options = {}) {
    ...
    if (url.indexOf('soundcloud') !== -1)
        ...
        return await stream_1.stream(url, options);
}
...
async function stream_from_info(info, options = {}) {
    if (info instanceof classes_1.SoundCloudTrack)
        return await SoundCloud_2.stream_from_info(info, options.quality);
    else
        return await stream_1.stream_from_info(info, options);
}
